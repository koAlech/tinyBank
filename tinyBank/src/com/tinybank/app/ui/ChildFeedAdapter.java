...
public class ChildFeedAdapter extends ArrayAdapter<Feed> {

	private final Context mContext;
    private final BitmapCache mMemoryCache;

    public ChildFeedAdapter(Context context) {
		super(context, R.layout.channel_feed_item);
		mContext = context;
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.channel_feed_item, parent, false);
            viewHolder = new ViewHolder();
            viewHolder.textViewName = (TextView) view.findViewById(R.id.channel_feed_name);
            viewHolder.textViewDesc = (TextView) view.findViewById(R.id.channel_feed_desc);
            viewHolder.textViewDate = (TextView) view.findViewById(R.id.channel_feed_date);
            viewHolder.imageView = (ImageView) view.findViewById(R.id.channel_feed_imageview);
            viewHolder.imageGreen = (ImageView) view.findViewById(R.id.channel_feed_action_green);
            viewHolder.imageRed = (ImageView) view.findViewById(R.id.channel_feed_action_red);
            viewHolder.imagePending = (ImageView) view.findViewById(R.id.channel_feed_action_pending);
            viewHolder.imageLike = (ImageView) view.findViewById(R.id.channel_feed_action_like);
